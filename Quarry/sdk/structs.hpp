...
public:
    ...
    NETVAR(Vector, m_vecVelocityGrenade, crypt_str("CBaseGrenade"), crypt_str("m_vecVelocity"));
    NETVAR(CHandle<player_t>, m_hThrower, "CBaseGrenade", "m_hThrower");
    NETVAR(Vector, m_vecOriginGrenade, crypt_str("CBaseCSGrenadeProjectile"), crypt_str("m_vecOrigin"));
