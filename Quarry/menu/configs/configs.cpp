...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.esp.grenade_proximity_warning_progress_color, Color(255, 255, 255), crypt_str("Esp.grenade_proximity_warning_progress_color"));
...
{
	std::string file = crypt_str("C:\\Quarry\\Configs\\CSGO\\") + config;
	json allJson;
...
{
	std::string file = crypt_str("C:\\Quarry\\Configs\\CSGO\\");
