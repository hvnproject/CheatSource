...
namespace ImGui
{
    ...
    IMGUI_API bool          animated_tab_button(const char* label, const char* icon, ImFont* icon_font, const ImVec2& size_arg = ImVec2(0, 0), bool acitve = false, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API void          TextSeparator(const char* label = "", ImGuiSeparatorFlags flags = 0);
