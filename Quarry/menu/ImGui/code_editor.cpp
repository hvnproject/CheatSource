...
void TextEditor::HandleKeyboardInputs()
{
	...
	auto wtf = ctrl && ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Backspace));
...
void TextEditor::Render(const char* aTitle, const ImVec2& aSize, bool aBorder)
{
	...
	mPalette[(int)PaletteIndex::Background] = ImGui::ColorConvertFloat4ToU32(ImGui::GetStyle().Colors[ImGuiCol_ChildBg]);
